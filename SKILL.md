...
## Identity and personal-name exclusion

本 Skill 及其生成、示例、测试和发布产物中，禁止出现用户指定的个人姓名或署名信息。默认不写入作者姓名、个人署名、个人联系方式或其他可识别个人信息；如历史文件已包含此类信息，必须在交付前全量检索并删除或中性化。该规则适用于 Markdown、HTML、脚本、配置、示例、日志和文档，不得仅清理用户可见页面而保留在后台文件中。
